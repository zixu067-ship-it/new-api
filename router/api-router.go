...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/mirror/group/:code", controller.GetMirrorGroupInfo)
    ...
    // 公开邀请预览（不需登录）
                ...
                agentRoute.Use(middleware.UserAuth())
                {
                  ...
                  agentRoute.DELETE("/group", controller.DissolveGroup)
                        ...
                        agentRoute.GET("/leaderboard", controller.GetPromoLeaderboard)
                        agentRoute.GET("/leaderboard/history", controller.GetPromoLeaderboardHistory)
                }
